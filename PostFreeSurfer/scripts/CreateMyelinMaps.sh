...
${CARET7DIR}/wb_command -surface-resample ${StudyFolder}/${Subject}/processed/T1w/${NativeFolder}/${Subject}.L.midthickness.native.surf.gii \
	...
	BARYCENTRIC ${StudyFolder}/${Subject}/processed/T1w/${Subject}.L.midthickness.${HighResMesh}k_fs_LR.surf.gii
${CARET7DIR}/wb_command -surface-resample ${StudyFolder}/${Subject}/processed/T1w/${NativeFolder}/${Subject}.R.midthickness.native.surf.gii \
	...
	BARYCENTRIC ${StudyFolder}/${Subject}/processed/T1w/${Subject}.R.midthickness.${HighResMesh}k_fs_LR.surf.gii
...
if [ "${T2wPresent}" = "YES" ] ; then
	...
	## To work on Mac machines:
	NumRefSurfVertices=$(${CARET7DIR}/wb_command -file-information "$ReferenceMyelinMaps" -only-cifti-xml | perl -nle'print $& and exit while m{SurfaceNumberOf(Vertices|Nodes)="\K\d+}g')
	...
	for ResMesh in "${AllAvailableMeshesArray[@]}" ; do
		...
		NumSurfVertices=$(perl -nle'print $& and exit while m{Dim0="\K\d+}g' ${HCPPIPEDIR}/global/templates/standard_mesh_atlases/L.atlasroi.${ResMesh}k_fs_LR.shape.gii)
	...
	case "$RefResMesh" in
		(${HighResMesh})
			...
			T1wSurfFolder=${StudyFolder}/${Subject}/processed/T1w
			;;
		(*)
			SphereFolder=${AtlasSpaceFolder}/fsaverage_LR${RefResMesh}k
			T1wSurfFolder=${StudyFolder}/${Subject}/processed/T1w/fsaverage_LR${RefResMesh}k
			;;
	esac
	...
	if [ "$RefResMesh" != "${LowResMesh}" ]; then
		...
		${CARET7DIR}/wb_command -cifti-resample ${ReferenceMyelinMaps} \
				...
				-left-area-surfs ${T1wSurfFolder}/${Subject}.L.midthickness.${RefResMesh}k_fs_LR.surf.gii ${StudyFolder}/${Subject}/processed/T1w/fsaverage_LR${LowResMesh}k/${Subject}.L.midthickness.${LowResMesh}k_fs_LR.surf.gii \
				...
				-right-area-surfs ${T1wSurfFolder}/${Subject}.R.midthickness.${RefResMesh}k_fs_LR.surf.gii ${StudyFolder}/${Subject}/processed/T1w/fsaverage_LR${LowResMesh}k/${Subject}.R.midthickness.${LowResMesh}k_fs_LR.surf.gii
	fi
	...
	for MyelinMap in MyelinMap SmoothedMyelinMap ; do
		...
		${CARET7DIR}/wb_command -cifti-resample ${AtlasSpaceFolder}/${NativeFolder}/${Subject}.${MyelinMap}_BC.native.dscalar.nii \
			...
			-left-area-surfs ${StudyFolder}/${Subject}/processed/T1w/${NativeFolder}/${Subject}.L.midthickness.native.surf.gii ${StudyFolder}/${Subject}/processed/T1w/${Subject}.L.midthickness.${HighResMesh}k_fs_LR.surf.gii \
			...
			-right-area-surfs ${StudyFolder}/${Subject}/processed/T1w/${NativeFolder}/${Subject}.R.midthickness.native.surf.gii ${StudyFolder}/${Subject}/processed/T1w/${Subject}.R.midthickness.${HighResMesh}k_fs_LR.surf.gii
		# gifti files
	...
	# rm ${StudyFolder}/${Subject}/processed/T1w/${Subject}.L.midthickness.${HighResMesh}k_fs_LR.surf.gii ${StudyFolder}/${Subject}/processed/T1w/${Subject}.R.midthickness.${HighResMesh}k_fs_LR.surf.gii
	...
	for LowResMesh in "${LowResMeshesArray[@]}" ; do
		for MyelinMap in MyelinMap SmoothedMyelinMap ; do
			${CARET7DIR}/wb_command -cifti-resample ${AtlasSpaceFolder}/${NativeFolder}/${Subject}.${MyelinMap}_BC.native.dscalar.nii \
				...
				-left-area-surfs ${StudyFolder}/${Subject}/processed/T1w/${NativeFolder}/${Subject}.L.midthickness.native.surf.gii ${StudyFolder}/${Subject}/processed/T1w/fsaverage_LR${LowResMesh}k/${Subject}.L.midthickness.${LowResMesh}k_fs_LR.surf.gii \
				...
				-right-area-surfs ${StudyFolder}/${Subject}/processed/T1w/${NativeFolder}/${Subject}.R.midthickness.native.surf.gii ${StudyFolder}/${Subject}/processed/T1w/fsaverage_LR${LowResMesh}k/${Subject}.R.midthickness.${LowResMesh}k_fs_LR.surf.gii
			# gifti files
