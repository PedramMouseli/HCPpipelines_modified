...
AtlasSpaceFolderDummyStr="MNINonLinear"
T1wFolderDummyStr="/T1w/"
...
AtlasSpaceFolder="$StudyFolder/$Subject/processed/MNINonLinear"
mesh="164k_fs_LR"
...
sed -e "s|${StudyFolderDummyStr}|${relPathToStudy}|g" \
    ...
    -e "s|${AtlasSpaceFolderDummyStr}|"processed/${AtlasSpaceFolderDummyStr}"|g" \
    -e "s|${T1wFolderDummyStr}|"/processed${T1wFolderDummyStr}"|g" \
